...
export const ETHIOPIAN_TAX_CATEGORIES = [
  'Category A - Large Taxpayer (>ETB 1M)',
  'Category B - Medium Taxpayer (ETB 500k-1M)',
  'Category C - Small Taxpayer (<ETB 500k)',
];
...
export const INITIAL_ACCOUNTS: Account[] = [
  {
    ...
    vatCode: 'N/A',
    whtCode: 'N/A',
    ethiopianTaxCategory: 'Category A - Large Taxpayer (>ETB 1M)',
