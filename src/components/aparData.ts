...
// Customized for Mesfin PLC Accounting System (ERCA & IFRS compliant)
...
export const FIELD_SPECS: FieldSpec[] = [
  { page: 'Supplier Form', section: 'Identity', name: 'Company / Legal Entity', key: 'company', type: 'String', ctrlType: 'Dropdown / Select', req: true, editable: true, defVal: 'MS-PLC', validation: 'Must match valid operating ledger company entity.', expVal: 'MS-PLC' },
...
export const LOOKUP_DATA = [
  { group: 'Company', code: 'MSF', name: 'Mesfin PLC Head Office', desc: 'Primary corporate entity' },
